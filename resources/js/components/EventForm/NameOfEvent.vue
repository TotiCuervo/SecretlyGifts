<template>
    <div>
        ...
        <p v-if="!nameCheck" class="text-red-600 font-extrabold text-sm w-full">There must be a name for this event</p>
    </div>
</template>
    ...
    export default {
        ...
        computed: {
            ...
            name: {
                ...
                set (value) {
                    return this.$store.commit('event/SET_FORM_NAME', value);
                }
            },
            nameCheck() {
